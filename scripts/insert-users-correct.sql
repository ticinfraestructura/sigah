...
INSERT INTO users (id, "firstName", "lastName", email, password, "roleId", "isActive", "createdAt", "updatedAt") VALUES
  ('u0000000-0000-0000-0000-000000000001', 'Admin', 'Test', 'admin@test.com', '$2b$10$test_hash', 'r0000000-0000-0000-0000-000000000001', true, NOW(), NOW()),
  ('u0000000-0000-0000-0000-000000000002', 'Operador', 'Test', 'operador@test.com', '$2b$10$test_hash', 'r0000000-0000-0000-0000-000000000002', true, NOW(), NOW())
ON CONFLICT DO NOTHING;
